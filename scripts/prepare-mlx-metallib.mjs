...
const qwenBuildDirPrefixes = ["qwen3-asr-rs-", "qwen3_asr-"];
...
function prepareMetallib() {
  ...
  if (!fallbackCandidates.length) {
    console.error(
      [
        "Unable to find mlx.metallib generated by qwen3-asr-rs.",
        `Looked under: ${targetRoots.join(", ")}`,
        `Expected a Cargo build directory starting with: ${qwenBuildDirPrefixes.join(", ")}`,
      ].join("\n"),
    );
    process.exitCode = 1;
    return;
